...
int isBranch=0,bubble_2=0,branch_time;
...
int main()
{
    ...
    while(1){
        ...
        if(cycle>1&&cycle<2+count3){
            ...
            if(isBranch==1&&bubble_2==1){
                fout<<"ReadData1\t0\nReadData2\t0\nsign_ext\t0\nRs\t\t0\nRt\t\t0\nRd\t\t0\nControl signals\t000000000";

                //to do the adjustment when branch happen
                dcount=dcount+branch_time;
            }

            //this is a bubble in this stage
            else if(isLoad==1&&bubble==1){
        ...
        if(cycle>2&&cycle<3+count3){
            ...
            //this is a bubble in this stage
            if(isBranch==1&&bubble_2==2){
                fout<<"ALUout\t\t0\nWriteData\t0\nRt/Rd\t\t0\nControl signals\t00000";

                //to do the adjustment when branch happen
                ecount=ecount+branch_time;
            }

            //this is a bubble in this stage
            else if(isLoad==1&&bubble==2){
        ...
        if(cycle>3&&cycle<4+count3){
            ...
            //this is a bubble in this stage
            if(isBranch==1&&bubble_2==3){
                fout<<"ReadData\t0\nALUout\t\t0\nRt/Rd\t\t0\nControl signals\t00";

                //to do the adjustment when branch happen
                mcount=mcount+branch_time;
                position_2=position_2+branch_time*32;
            }

            //this is a bubble in this stage
            else if(isLoad==1&&bubble==3)
        ...
        if(ins[position_5-32]=='0'&&ins[position_5-31]=='0'&&ins[position_5-30]=='0'&&ins[position_5-29]=='1'&&ins[position_5-28]=='0'&&ins[position_5-27]=='1'&&(rt[dcount-1]!=rs[dcount-1])){
            isBranch=1;
        }

        //load hazard detect
        else if(ins[position_5-32]=='1'&&ins[position_5-31]=='0'&&ins[position_5-30]=='0'&&ins[position_5-29]=='0'&&ins[position_5-28]=='1'&&ins[position_5-27]=='1'&&(rt[dcount-1]==rs[dcount]||rt[dcount-1]==rt[dcount])){
            isLoad=1;
        }
        ...
        if(isBranch==1){
            bubble_2++;
            //the adjustment when branch hazard happen
            if(bubble_2==1){
                branch_time=ext[dcount-1];
                pc=pc+branch_time;
                position=position+32*(branch_time-1);
                count1=count1-branch_time+1;
                count3=count3-branch_time+1;
            }
            //the bubble is in the end
            else if(bubble_2==4)
                isBranch=0;
